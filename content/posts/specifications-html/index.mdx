...
Web開発に取り組むと「コードを打ち込む時間」よりも「適切なコードを調べている時間」が長い傾向にあります。この原因は、Web技術が非常に広範な分野であり、なおかつ進化も早いため、学習や実践の過程で多くの疑問や課題に直面することが避けられないためです。

効率的に情報収集するにはネット検索を積極的に使用すべきですが、問題は「情報の海」から信頼できる情報を探し出すことです。こちらの記事が参考になります。
